...
resource "redfish_idrac_server_configuration_profile_export" "nfs" {
  for_each = var.rack1
...
resource "redfish_idrac_server_configuration_profile_export" "cifs" {
  for_each = var.rack1
...
resource "redfish_idrac_server_configuration_profile_export" "http" {
  for_each = var.rack1
