...
resource "redfish_boot_order" "boot" {
  ...
  # boot_order =["HardDisk.List.1-1","NIC.Integrated.1-2-1","NIC.Integrated.1-3-1","NIC.Integrated.1-4-1","NIC.Integrated.1-1-1"]
  # boot_order =["NIC.Integrated.1-1-1","HardDisk.List.1-1"]


  boot_order = ["Boot0004", "Boot0000", "Boot0007", "Boot0005"]
