...
This Terraform resource is used to manage user resource of the iDRAC Server. We can create, read, modify and delete an existing user using this resource.
...
After the successful execution of the above resource block, an new user would have got created, if not already present. It can be verified through state file.
