		...
		Steps: []resource.TestStep{
			{
				...
				ImportState:   true,
				ImportStateId: "{\"id\":\"/redfish/v1/Systems/System.Embedded.1/Storage/RAID.Integrated.1-1/Volumes/Disk.Virtual.1:RAID.Integrated.1-1\",\"username\":\"root\",\"password\":\"calvin\",\"endpoint\":\"https://10.226.197.128\",\"ssl_insecure\":true}",
				ExpectError:   nil,
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				ResourceName:  "redfish_storage_volume.volume",
				ImportState:   true,
				ImportStateId: "{\"id\":\"invalid\",\"username\":\"root\",\"password\":\"calvin\",\"endpoint\":\"https://10.226.197.128\",\"ssl_insecure\":true}",
