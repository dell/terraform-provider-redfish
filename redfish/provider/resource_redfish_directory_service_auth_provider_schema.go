...
// DirectoryServiceAuthProviderSchema defines the schema for the resource.
func DirectoryServiceAuthProviderSchema() map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		"active_directory": schema.SingleNestedAttribute{
			MarkdownDescription: "Active Directory" + noteADMessageInclusive + " , " + noteMessageExclusive,
			Description:         "Active Directory" + noteADMessageInclusive + " , " + noteMessageExclusive,
		...
		"ldap": schema.SingleNestedAttribute{
			MarkdownDescription: "LDAP" + noteLDAPMessageInclusive + " , " + noteMessageExclusive,
			Description:         "LDAP" + noteLDAPMessageInclusive + " , " + noteMessageExclusive,
		...
		"active_directory_attributes": schema.MapAttribute{
			MarkdownDescription: "ActiveDirectory.* attributes in Dell iDRAC attributes." + noteADMessageInclusive + " : " + noteAttributesMessageExclusive,
			Description:         "ActiveDirectory.* attributes in Dell iDRAC attributes." + noteADMessageInclusive + " : " + noteAttributesMessageExclusive,
		...
		"ldap_attributes": schema.MapAttribute{
			MarkdownDescription: "LDAP.* attributes in Dell iDRAC attributes." + noteLDAPMessageInclusive + " : " + noteAttributesMessageExclusive,
			Description:         "LDAP.* attributes in Dell iDRAC attributes." + noteLDAPMessageInclusive + " : " + noteAttributesMessageExclusive,
			ElementType:         types.StringType,
			Computed:            true,
			Optional:            true,
			Validators: []validator.Map{
