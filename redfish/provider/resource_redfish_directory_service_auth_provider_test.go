		...
		Steps: []resource.TestStep{
...

			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					//resource.TestCheckResourceAttr(terraformDSAuthProviderResourceName, "active_directory_attributes.ADGroup.1.Domain", "yulan.pie.lab.emc.com"),
				),
			},

			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					//resource.TestCheckResourceAttr(terraformDSAuthProviderResourceName, " ldap_attributes.LDAP.1.GroupAttributeIsDN", "Enabled"),
				),
			},
			{
