...
// DirectoryServiceAuthProviderExtended contains gofish AccountService data, as well as Accounts,AdditionalExternalAccountProviders,Roles,PrivilegeMap,ActiveDirectoryCertificate,LDAPCertificate links
...
// This is the wrapper that extracts and parses AccountService data, as well as Accounts,AdditionalExternalAccountProviders,Roles,PrivilegeMap,ActiveDirectoryCertificate,LDAPCertificate links.
