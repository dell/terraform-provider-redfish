...
// can be customized.
//nolint:all
//go:generate go run github.com/hashicorp/terraform-plugin-docs/cmd/tfplugindocs generate --rendered-website-dir docs --provider-name terraform-provider-redfish
